    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.gov_params = QueryParamsResponse3.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): QueryParamsResponse {
    return {
      ...
      fees_params: isSet(object.fees_params)
        ? Params2.fromJSON(object.fees_params)
        : undefined,
      ...
      stakers_params: isSet(object.stakers_params)
        ? Params4.fromJSON(object.stakers_params)
        : undefined,
    };
  },
  ...
  toJSON(message: QueryParamsResponse): unknown {
    ...
    message.fees_params !== undefined &&
      (obj.fees_params = message.fees_params
        ? Params2.toJSON(message.fees_params)
        : undefined);
    message.gov_params !== undefined &&
      (obj.gov_params = message.gov_params
        ? QueryParamsResponse3.toJSON(message.gov_params)
        : undefined);
    message.stakers_params !== undefined &&
      (obj.stakers_params = message.stakers_params
        ? Params4.toJSON(message.stakers_params)
        : undefined);
    return obj;
  },
